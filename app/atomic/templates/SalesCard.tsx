...
const SalesCard = ({ imgSrc, prodName, prevPrice,  currentPrice, badgeValue, isFilled }: cardProps) => {
    return (
        <main className={`h-fit sm:shadow-shadow shadow-shadow_md rounded-md box-border transition-all duration-75`}>
            <section className="md:h-[200px] relative flex items-center flex-col justify-center h-[100px] md:p-[20px] p-[10px]  overflow-hidden">
            ...
            <section className={isFilled ? "bg-grey10 md:p-[20px] p-[10px] " : "bg-transparent md:p-[20px] p-[10px] "}>
                <div className="md:mb-[9px] mb-[5px] flex items-center justify-between">
                    ...
                    <div className="bg-orange w-[40px] h-[40px] rounded-full flex items-center justify-center text-white">
