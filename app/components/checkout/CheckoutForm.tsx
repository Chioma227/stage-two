    ...
    return (
        <main>
            <div>
                ...
                <input type="text" className='outline-none border-none bg-inputBG px-[6px] py-[8px] md:w-[400px] w-full mb-[20px] rounded-[5px]' />
            </div>
            <div>
            ...
            <div className='flex items-center '>
                <input type="checkbox" className=' accent-orange text-white' /><span className='sm:text-base text-[12px]'>Save this information for fast checkout next time</span>
            </div>
        </main>
    )
}
